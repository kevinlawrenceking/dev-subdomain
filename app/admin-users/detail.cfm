<!---
    Admin User Management - User Detail Page
    /app/admin-users/detail.cfm?userid=N

    Displays user profile, admin actions (status toggle, email send),
    email preview, and edit form. Admin-only via admin-guard.cfm.
--->
...
<head>
    ...
    <title>User Detail | TAO Admin</title>
...
<body class="bg-light">
    <div class="container-fluid py-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                ...
                <h1 class="h3 mb-0" id="pageTitle">User Detail</h1>
            </div>
            <div>
    ...
    (function() {
        ...
        function renderUser() {
            ...
            document.title = firstName + ' ' + lastName + ' | TAO Admin';
