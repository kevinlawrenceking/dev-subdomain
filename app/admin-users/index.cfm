<!---
    ...
    /app/admin-users/index.cfm

    Displays a searchable, filterable, paginated table of all users.
    Admin-only access enforced by admin-guard.cfm.
--->
...
<head>
    ...
    <title>User Management | TAO Admin</title>
...
<body class="bg-light">
    <div class="container-fluid py-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div>
                <button id="btnCreateUser" class="btn btn-primary btn-sm me-2" data-bs-toggle="modal" data-bs-target="#userModal">
                    + New User
                </button>
                <a href="/app/" class="btn btn-outline-secondary btn-sm">Back to App</a>
            </div>
        </div>
    ...
    (function() {
        ...
        $(function() {
            ...
            $(document).on('click', '.user-row td:not(:last-child)', function() {
                ...
                window.location.href = '/app/admin-users/detail.cfm?userid=' + uid;
            });
