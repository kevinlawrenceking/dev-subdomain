...
<cfsavecontent variable="events_loop">
    ...
    <cfloop query="events">
        ...
        <cfif NOT isDate(eventStopTime) OR (dateCompare(eventStopDate, eventStartDate) EQ 0 AND timeCompare(eventStopTime, eventStartTime) LTE 0)>
            <!--- If same date and stop time is before or equal to start time, add 1 hour --->
