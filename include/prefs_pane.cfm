...
<!--- Audition Union Countries Section --->
<cfinclude template="/include/qry/audunion_countries_sel.cfm" />

<div class="preferences-section">
    <div class="section-header">
        <h5 class="section-title">
            <i class="mdi mdi-flag-variant me-2"></i>Audition Union Countries
        </h5>
        <button class="btn btn-outline-primary btn-sm edit-settings-btn"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="updatePrefCountriesLabel">Audition Union Countries</h4>
