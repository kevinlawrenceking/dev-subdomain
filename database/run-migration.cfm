...
<cfif qCheckMappingData.cnt eq 0>
    ...
    <cfset arrayAppend(response.results, "Seeded field mappings (25 fields)")>
<cfelse>
    <cfset arrayAppend(response.results, "Field mappings exist (" & qCheckMappingData.cnt & " fields)")>
</cfif>
...
<cfif qCheckAliasData.cnt eq 0>
    ...
    <cfset arrayAppend(response.results, "Seeded field aliases (57 aliases)")>
<cfelse>
    <cfset arrayAppend(response.results, "Field aliases exist (" & qCheckAliasData.cnt & " aliases)")>
</cfif>
...
<cfset arrayAppend(response.results, "Added extra aliases (INSERT IGNORE)")>

<cfset response.success = true>
<cfset response.message = "Migration completed successfully">
