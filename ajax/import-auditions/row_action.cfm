<cfsilent>
<!---
    Audition Import - Row Action Endpoint
    POST /ajax/import-auditions/row_action.cfm
...
<cftry>
    ...
    <cfif variables.isBulk or arrayLen(variables.rowIds) gt 1>
        <!--- Bulk operation --->
        <cfset variables.actionResult = variables.auditionService.bulkRowAction(
    ...
    <cfelse>
        ...
        <cfset variables.actionResult = variables.auditionService.setRowAction(
            job_id = variables.jobId,
